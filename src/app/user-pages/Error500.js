...
export class BasicElements extends Component {
  ...
  onButtonClickHandler = () => {
    window.open("http://localhost:3000/demo/star-admin-free/react/template/demo_1/dashboard","_self")
    window.alert('Mise à jour réussie')
    
    
  };

  onButtonClickHandlerAlart = () => {
    
    window.alert("Il y a des informations non sauvegardées!")
    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Réglage </h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><a href="http://localhost:3000/demo/star-admin-free/react/template/demo_1/form-elements/basic-elements" onClick={()=> window.open("http://localhost:3000/demo/star-admin-free/react/template/demo_1/form-elements/basic-elements","_self")}>English (EN)</a></li>
              <li className="breadcrumb-item"><a href="!#" onClick={event => event.preventDefault()}><u>French (FR)</u></a></li>
              ...
              <div className="card-body">
                ...
                <form className="forms-sample">
                  <Form.Group>
                    ...
                    <Form.Control type="text" className="form-control" id="exampleInputName1" placeholder="Nom" value="Henry Chen"/>
                  </Form.Group>
                  <Form.Group>
                    <label htmlFor="exampleInputEmail3">Adresse e-mail</label>
                    <Form.Control type="email" className="form-control" id="exampleInputEmail3" placeholder="Email" value="henryctest@gmail.com"/>
                  </Form.Group>
                  <Form.Group>
                    <label htmlFor="exampleInputPassword4">Mot de passe</label>
                    <Form.Control type="password" className="form-control" id="exampleInputPassword4" placeholder="Password" />
                    </Form.Group>
                    <Form.Group>
                    <label htmlFor="exampleSelectGender">Le sexe</label>
                  ...
                  <Form.Group>
                    ...
                    <div className="input-group col-xs-12">
                      <Form.Control type="text" className="form-control file-upload-info" disabled placeholder="Télécharger l'image" /> 
                      <span className="input-group-append">
                        <button className="file-upload-browse btn btn-primary" type="button">Télécharger</button>
                      </span>
                    </div>
                  </Form.Group>
                  <Form.Group>
                    <label htmlFor="exampleInputCity1">Emplacement</label>
                    <Form.Control type="text" className="form-control" id="exampleInputCity1" placeholder="Location" value="Ottawa, ON"/>
                  </Form.Group>
                  <Form.Group>
                    <label htmlFor="exampleTextarea1">La description</label>
                    <textarea className="form-control" id="exampleTextarea1" rows="4"></textarea>
                  </Form.Group>
                  <button type="submit" className="btn btn-primary mr-2" onClick={this.onButtonClickHandler} >Mettre à jour</button>
                  <button className="btn btn-light" onClick={this.onButtonClickHandlerAlart}>Annuler</button>
                </form>
              </div>
            </div>
          </div>
