    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a className="sidebar-brand brand-logo" href="index.html"><img style={logosize} src={require("../../assets/images/logo.png")} alt="logo" />The Analyzer</a>
          <a className="sidebar-brand brand-logo-mini pt-3" href="index.html"><img style={logosizemini}src={require("../../assets/images/logo-mini.png" )} alt="logo" /></a>
        </div>
        <ul className="nav">
            ...
            <div className="nav-link">
              <Dropdown>
                <Dropdown.Toggle className="nav-link user-switch-dropdown-toggler p-0 toggle-arrow-hide bg-transparent border-0 w-100">
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <div className="text-left ml-3">
                      <p className="profile-name">Henry Chen</p>
                ...
                <Dropdown.Menu className="preview-list navbar-dropdown">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center text-small" onClick={()=> window.open("http://localhost:3000/demo/star-admin-free/react/template/demo_1/form-elements/basic-elements","_self")}>
                    Manage Accounts
                  </Dropdown.Item>
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center text-small" onClick={evt =>evt.preventDefault()}>
                  Change Password 
                  </Dropdown.Item>
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center text-small" onClick={()=> window.open("http://localhost:3000/demo/star-admin-free/react/template/demo_1/user-pages/error-404","_self")}>
                    Check Inbox
                  </Dropdown.Item>
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center text-small" onClick={()=> window.open("https://henrychen666.github.io/The-Analyzer/","_self")}>
                    Sign Out
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
          ...
          <li className={ this.isPathActive('/user-pages') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.userPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <Link className={ this.isPathActive('/user-pages/blank-page') ? 'nav-link active' : 'nav-link' } to="/user-pages/blank-page">More Options</Link></li>
