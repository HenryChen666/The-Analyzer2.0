    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Sells </h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"><a href="!#" onClick={event => event.preventDefault()}>Tables</a></li>
              <li className="breadcrumb-item active" aria-current="page">Sells</li>
            </ol>
          </nav>
        </div>
        <div className="row">
          ...
          <div className="col-lg-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Team Members Status</h4>
                <p className="card-description"> Sells Status <code></code>
                </p>
                <div className="table-responsive">
                  <table className="table table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td>Jacob</td>
                        <td>Nike</td>
                        <td className="text-success"> 28.76% <i className="mdi mdi-arrow-up"></i></td>
                        <td><label className="badge badge-danger">Pending</label></td>
                      </tr>
                      <tr>
                        <td>Henry</td>
          ...
          <div className="col-lg-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Members Status</h4>
